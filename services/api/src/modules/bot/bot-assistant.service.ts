    ...
    return {
      ...
      keyboard: {
        inline_keyboard: [
          ...
          [{ text: '🚀 Open Mini App', web_app: { url: process.env.TELEGRAM_WEBAPP_URL || 'https://tetherstream.app' } }],
        ],
      },
    };
  }
